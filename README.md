...
- 정답이면 자동 다음 문장, 제한 시간이 지나도 자동 다음 문장
- 순차 또는 무작위 재생
...
기본 형식은 첫 번째 행에 한국어, 두 번째 행에 대응하는 영어를 넣는 방식입니다.

| A | B | C |
|---|---|---|
| 안녕하세요 | 기다려 볼까요? | 좋은 생각이에요 |
| Hello | What if we wait? | That's a good idea |

두 열 형식(`A열=한국어`, `B열=영어`)도 자동으로 인식합니다. 첫 번째 시트만 읽으며, 빈 셀 쌍은 건너뜁니다.
